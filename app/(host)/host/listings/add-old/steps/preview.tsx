        ...
        <div>
            ...
            <div className='flex flex-col gap-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[42px] items-start'>
                    ...
                    <Button
                        className='!bg-white !text-primary border border-primary flex justify-center items-center gap-2 w-[230px] md:self-start md:place-self-end'>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-x-6">
                        <Button
                            ...
                            className="text-primary border border-primary bg-white text-p h-14">Save and Exit</Button>
                        <Button
                            onClick={() => {
                                onSubmit(true)
                            }}
                            className="text-white text-p lg:w-[140px] h-14">
                            Publish
                        </Button>
                    </div>
