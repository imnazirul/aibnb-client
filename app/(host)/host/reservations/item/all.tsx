        ...
        <div>
            {
                bookings?.docs?.length === 0 && (
                    <div className='w-full my-[128px] mx-auto flex flex-col justify-center items-center'>
                        <h4 className='text-h4 font-semibold'>You have no reservations</h4>
            ...
            <table className="w-full text-left mt-2 mb-6">
                ...
                <tbody>
                    {bookings?.['docs']?.map((data, index) => (
                        <tr key={index} className="text-sm text-gray-500 font-medium">
                            <td className="py-2 flex gap-6 items-center hover:bg-gray-50 cursor-pointer">
                                <Image
                                    height={700}
                                    width={700}
