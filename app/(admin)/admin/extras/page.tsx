...
const Features = () => {
    ...
    const [data, getData] = useFetch(fetchPropertyFeatures)
    ...
    return (
        <>
            <PageTitle title="Extra Features"/>
            <Table
                columns={columns}
                data={data}
                item="Feature"
            ...
            <Modal
                ...
                <Form
                    ...
                    onFinish={values => {
                        ...
                        let func = !!values?.uid ? patchPropertyFeature : postPropertyFeature
